...
class PublicPagesController {
    ...
    public static function about($request, $response, $service) {
        $pageData['featuredPost'] = FeaturedPost::getFeaturedPost();
        $pageData['collections'] = PostCollection::getFeaturedCollections();
        $pageData['topics'] = Topic::selectAll();

        $service->render('views/about.php', $pageData);
    }

    public static function team($request, $response, $service) {
        $pageData['featuredPost'] = FeaturedPost::getFeaturedPost();
        $pageData['collections'] = PostCollection::getFeaturedCollections();
        $pageData['topics'] = Topic::selectAll();

        $service->render('views/team.php', $pageData);
    }

    public static function portfolio($request, $response, $service) {
        $pageData['featuredPost'] = FeaturedPost::getFeaturedPost();
        $pageData['collections'] = PostCollection::getFeaturedCollections();
        $pageData['topics'] = Topic::selectAll();

        $service->render('views/portfolio.php', $pageData);
    }
}
